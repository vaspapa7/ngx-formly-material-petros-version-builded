(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@ngx-formly/core'), require('@ngx-formly/core/select'), require('@angular/forms'), require('@ngx-formly/material/form-field'), require('@angular/material/input')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/material/native-select', ['exports', '@angular/core', '@angular/common', '@ngx-formly/core', '@ngx-formly/core/select', '@angular/forms', '@ngx-formly/material/form-field', '@angular/material/input'], factory) :
    (global = global || self, factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].material = global['ngx-formly'].material || {}, global['ngx-formly'].material['native-select'] = {}), global.ng.core, global.ng.common, global.core$1, global.select, global.ng.forms, global['ngx-formly'].material['form-field'], global.ng.material.input));
}(this, (function (exports, core, common, core$1, select, forms, formField, input) { 'use strict';
