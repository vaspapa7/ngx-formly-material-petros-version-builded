(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@ngx-formly/core'), require('@ngx-formly/core/select'), require('@ngx-formly/material/form-field'), require('@angular/material/checkbox')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/material/multicheckbox', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@ngx-formly/core', '@ngx-formly/core/select', '@ngx-formly/material/form-field', '@angular/material/checkbox'], factory) :
    (global = global || self, factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].material = global['ngx-formly'].material || {}, global['ngx-formly'].material.multicheckbox = {}), global.ng.core, global.ng.common, global.ng.forms, global.core$1, global.select, global['ngx-formly'].material['form-field'], global.ng.material.checkbox));
}(this, (function (exports, core, common, forms, core$1, select, formField, checkbox) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyFieldMultiCheckbox = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChildren(checkbox.MatCheckbox),
