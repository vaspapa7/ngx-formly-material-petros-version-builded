(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@ngx-formly/core'), require('@angular/forms'), require('@ngx-formly/material/form-field'), require('@angular/material/input'), require('@angular/material/datepicker')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/material/datepicker', ['exports', '@angular/core', '@angular/common', '@ngx-formly/core', '@angular/forms', '@ngx-formly/material/form-field', '@angular/material/input', '@angular/material/datepicker'], factory) :
    (global = global || self, factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].material = global['ngx-formly'].material || {}, global['ngx-formly'].material.datepicker = {}), global.ng.core, global.ng.common, global.core$1, global.ng.forms, global['ngx-formly'].material['form-field'], global.ng.material.input, global.ng.material.datepicker));
}(this, (function (exports, core, common, core$1, forms, formField, input, datepicker) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyDatepickerTypeComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(input.MatInput, { static: true }),
            __metadata("design:type", input.MatInput)
        ], FormlyDatepickerTypeComponent.prototype, "formFieldControl", void 0);
        __decorate([
            core.ViewChild(datepicker.MatDatepickerInput, { static: true }),
            __metadata("design:type", datepicker.MatDatepickerInput)
        ], FormlyDatepickerTypeComponent.prototype, "datepickerInput", void 0);
        __decorate([
            core.ViewChild('datepickerToggle', { static: true }),
