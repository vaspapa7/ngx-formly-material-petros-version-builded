(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@ngx-formly/core'), require('@ngx-formly/core/select'), require('@ngx-formly/material/form-field'), require('@angular/material/select'), require('@angular/material/core')) :
    typeof define === 'function' && define.amd ? define('@ngx-formly/material/select', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@ngx-formly/core', '@ngx-formly/core/select', '@ngx-formly/material/form-field', '@angular/material/select', '@angular/material/core'], factory) :
    (global = global || self, factory((global['ngx-formly'] = global['ngx-formly'] || {}, global['ngx-formly'].material = global['ngx-formly'].material || {}, global['ngx-formly'].material.select = {}), global.ng.core, global.ng.common, global.ng.forms, global.core$1, global.select, global['ngx-formly'].material['form-field'], global.ng.material.select, global.ng.material.core));
}(this, (function (exports, core, common, forms, core$1, select, formField, select$1, core$2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FormlyFieldSelect = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild(select$1.MatSelect, { static: true }),
            __metadata("design:type", select$1.MatSelect)
